...
The signed `xcodebuild test` command passes all 48 unit tests and all ten macOS
...
- Save/Discard/Cancel from the quit trigger (Project selection, Reload, and
  window close are covered).
